	...
	<div class="header">
		...
		<div class="container">
				...
				<div class="col-md-12">
					...
					<div class="col-md-4">
						<form class="front-page-form" id="front-page-form">
							...
							<div class="form-group">
								<input type="text" id="leadName" name="front-page-form-your-name" title="Your Name" placeholder="Your Name*" class="form-control">
							</div>
							<div class="form-group">
								<input type="text" id="leadEmail" name="front-page-form-your-email" title="Your Email" placeholder="Your Email" class="form-control">
								<input type="text" name="front-page-contact_me_by_fax_only" style="display:none !important" tabindex="-1" autocomplete="off">
							</div>
							<div class="form-group">
								<input type="text" id="leadPhone" name="front-page-form-your-phone" title="Your Phone" placeholder="Your Phone*" class="form-control">
							</div>
							<div class="form-group">
								<select class="form-control" title="are you using prescription" id="front-page-form-prescription">
									<option selected value="No">I have not used prescription medication.</option>
									<option value="Yes">I have used prescription medication.</option>
								</select>
							</div>
							<div>
								...
								<button class="btn btn-primary front-page-form-button" id="front-page-form-submission">Book a free consulation</button>
								<p class="front-page-form-subtext front-page-form-margin-bottom">(We will not share, sell, or spam your email.)</p>
								<p class="text-center" style="margin: 0; padding: 0; color: white; font-size: 12px;"><small>*Required Field</small></p>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="header-caption">
						<h1>Treatment of Major Depressive Disorder with TMS</h1>
						<div class="header-caption-buttons">
							<a href="https://activerecoverytms.com/patient-providers/">For Providers</a><a href="https://www.valantmed.com/Portal/activerecoverytms" target="_blank">Patient Login</a>
						</div>
					</div>
		</div>
	</div>
